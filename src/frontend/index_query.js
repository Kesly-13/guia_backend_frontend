...
id: document.querySelector('#id_persona'),
    ...
    nuid: document.querySelector('#nuid'),
...
async function manejarSubmit(e) {
    ...
    const persona = {
        ...
        numero_identificacion: campos.numero_identificacion.value,
...
async function editarPersona(persona) {
 ...
 // Restaelece el formulario al estado original
